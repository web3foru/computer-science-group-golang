...
type DifferenceHighPrecisionInteger interface {
	Subtraction(number1 *high_precision_integers.HighPrecisionInteger, number2 *high_precision_integers.HighPrecisionInteger) high_precision_integers.HighPrecisionInteger
